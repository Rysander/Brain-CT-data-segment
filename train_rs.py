...
class mIoULoss(nn.Module):
    ...
    def forward(self, inputs, target, loss0 = 100, loss_weight = [0.1,6,1,4,5,2,4,5,5]):
        ...
        loss2 = inter       #+0.0000001)#/(oneHot2 ** 2 + 0.0000001) *oneHot2 
